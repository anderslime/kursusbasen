...
SimpleForm.setup do |config|
  config.wrappers :bootstrap3, tag: 'div', class: 'form-group', error_class: 'error' do |b|
    ...
    b.use :placeholder
    b.use :label
    b.wrapper :controls, tag: 'div', class: 'col-lg-2' do |ba|
      ba.use :input
  ...
  config.wrappers :append, tag: 'div', class: "form-group", error_class: 'error' do |b|
    ...
    b.use :placeholder
    b.use :label
    b.wrapper :controls, tag: 'div', class: 'controls col-lg-2' do |input|
  ...
  config.wrappers :inline, tag: 'div', class: 'form-group' do |b|
    b.use :html5
    b.use :placeholder
    b.use :input
  end
